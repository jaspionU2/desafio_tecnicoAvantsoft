...
@router_student.get("/getStudents", response_model=StudentsList, status_code=status.HTTP_200_OK)
def getStudents():
    """
...
@router_student.post("/addNewStudent", response_model=StudentPublic, status_code=status.HTTP_201_CREATED)
